...
class Hossomaki extends StatefulWidget {
  const Hossomaki({Key? key}) : super(key: key);

  @override
  _HossomakiState createState() => _HossomakiState();
}

class _HossomakiState extends State<Hossomaki> {

  final List<String> imageList = [
    "images/Nova pasta/Hossomaki Skin.webp",
    "images/Nova pasta/Hossomaki Skin.webp",
    "images/Nova pasta/Hossomaki Skin.webp",
  ];
