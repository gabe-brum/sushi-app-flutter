...
class Gunkm extends StatefulWidget {
  const Gunkm({Key? key}) : super(key: key);

  @override
  _GunkmState createState() => _GunkmState();
}

class _GunkmState extends State<Gunkm> {

  final List<String> imageList = [
    "images/Nova pasta/Gunkam Salmão e Kani.webp",
    "images/Nova pasta/Gunkam Salmão e Kani.webp",
    "images/Nova pasta/Gunkam Salmão e Kani.webp",
  ];
